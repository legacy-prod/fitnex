...
<html>
<head>
    <title>Member Directory Updated</title>
    ...
    <style>
        ...
        .highlight { font-weight: bold; color: #cb8900; } /* Orange highlight for member directory name */
...
<body>
    <div class="container">
        <div class="header">
            <h2>Member Directory Update Notification</h2>
        </div>
        <div class="body">
            <p>Member Directory <span class="highlight">{{ $memberDirectory->title }}</span> has been updated by:</p>
