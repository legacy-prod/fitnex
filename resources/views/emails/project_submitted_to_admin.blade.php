    ...
    <div class="email-container">
        ...
        <div class="email-body">
            <p style="font-size:1.15rem; font-weight:500; margin-bottom: 10px;">
                A new project has been submitted by <strong>{{ $user->name }}</strong> ({{ $user->email }}).
            </p>
            <div class="project-info">
                <strong>Project Name:</strong> {{ $project->name }}
            </div>
            <a href="{{ route('projects.show', $project->id) }}" class="cta-button" target="_blank">View Project</a>
            <p style="margin-top:28px; color:#888; font-size:1rem;">
                Please review and approve or reject the project.
            </p>
        </div>
